...
! function(a) {
	...
	a.module("door3.css", []).run(function() {
		...
		this.debugMode = function(b) {
			...
			function s(b) {
				return b ? (a.isFunction(b) && (b = a.copy(f.invoke(b))), a.isString(b) && (b = a.extend({
					href: b
			...
			function t(a) {
				...
				var b = "?cache="; - 1 === a.href.indexOf(b) && (a.href = a.href + (a.bustCache ? b + (new Date).getTime() : ""))
			}
			...
			function v(a) {
				return a ? (A[a.href] = h.matchMedia(a.media), B[a.href] = function(b) {
					i(function() {
						if(b.matches) e.stylesheets.push(a);
						else {
							var c = e.stylesheets.indexOf(l("filter")(e.stylesheets, {
								href: a.href
							})[0]); - 1 !== c && e.stylesheets.splice(c, 1)
						}
					})
			...
			return a.forEach(c, function(a, b) {
				...
				return b ? (a.isArray(b) || (b = [b]), a.forEach(b, function(a) {
					a = s(a), a.href && !l("filter")(e.stylesheets, {
						href: a.href
					}).length && (t(a), x(a) ? v(a) : e.stylesheets.push(a), d && m.debug("$css.add(): " + a.href))
				...
				return b ? (a.isArray(b) || (b = [b]), b = l("filter")(b, function(a) {
					...
					a = s(a);
					var b = e.stylesheets.indexOf(l("filter")(e.stylesheets, {
						href: a.href
					})[0]); - 1 !== b && e.stylesheets.splice(b, 1), w(a), d && m.debug("$css.remove(): " + a.href)
